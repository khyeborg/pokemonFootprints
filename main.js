  					...
  					if (i == 648) {
  						...
  						for (let j = 0; j < bigArray.length - 9; j++) {
					  		...
					  		for (let k = 0; k < bigArray[j].length; k++) {
					  			if (bigArray[j][k][0].indexOf("-") == -1 && bigArray[j][k][0].indexOf("pansage") == -1 && bigArray[j][k][0].indexOf("pansear") == -1 && bigArray[j][k][0].indexOf("panpour") == -1 && bigArray[j][k][0].indexOf("simisage") == -1 && bigArray[j][k][0].indexOf("simisear") == -1 && bigArray[j][k][0].indexOf("simipour") == -1) {
